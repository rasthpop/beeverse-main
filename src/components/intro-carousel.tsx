...
function SlideIcon(
  ...
  return(
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} className={`${props.isActive ? " fill-[#FF6914]" : "text-transparent fill-[#FFFFFF] opacity-30"} z-[999] `}>
